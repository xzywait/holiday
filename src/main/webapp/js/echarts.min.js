!function (t, e) {
    ...
    return function (t) {
        ...
        var C, D = {
            ...
            "[object Image]": 1
        }, P = Object.prototype.toString, k = Array.prototype, z = k.forEach, O = k.filter, E = k.slice, R = k.map, N = k.reduce, V = {
            inherits: h,
            mixin: c,
            clone: i,
            merge: n,
         ...
         */
        var y = i(12), x = i(122), _ = i(87), b = i(23), w = i(123), S = i(10), M = i(15), T = i(57), A = i(27), I = i(3), L = i(76), C = i(1), D = i(18), P = i(20), k = i(44), z = C.each, O = 1e3, E = 5e3, R = 1e3, N = 2e3, V = 3e3, B = 4e3, G = 5e3, F = "__flag_in_main_process", H = "_hasGradientOrPatternBg", W = "_optionUpdated";
        ...
        var U = [], X = {}, Y = [], $ = [], Q = [], K = {}, J = {}, tt = {}, et = {}, it = new Date - 0, nt = new Date - 0, rt = "_echarts_instance_", ot = {
            version: "3.2.3",
        ...
        a.formatTime = function (t, e) {
            ...
            var i = r.parseDate(e), n = i.getFullYear(), o = i.getMonth() + 1, a = i.getDate(), s = i.getHours(), l = i.getMinutes(), h = i.getSeconds();
        ...
        var r = i(1), o = i(7), a = i(4), s = i(8), l = a.parsePercent, u = r.each, h = {}, c = ["left", "right", "top", "bottom", "width", "height"];
        ...
        (function (e) {
            ...
            var o = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === o ? Array : a.Float64Array, l = typeof a.Int32Array === o ? Array : a.Int32Array, u = {
                ...
                number: Array,
                time: Array
            }, h = i(9), c = i(45), d = i(1), f = i(11), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"], v = function (t, e) {
        ...
        "use strict";
        var n = i(1), r = i(8), o = i(11), a = i(10), s = i(56), l = i(12), u = r.encodeHTML, h = r.addCommas, c = a.extend({
        ...
        function s(t, e, i, r, o, a) {
            ...
            if (n(c) && n(d))if (n(l))a[0] = 0; else {
                ...
                if (n(v)) {
                    ...
                    var A = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), I = Math.acos(A) / 3, L = b(c), C = Math.cos(I), g = (-l - 2 * L * C) / (3 * s), y = (-l + L * (C + M * Math.sin(I))) / (3 * s), D = (-l + L * (C - M * Math.sin(I))) / (3 * s);
        ...
        var m = i(5), y = m.create, x = m.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-8, S = 1e-4, M = b(3), T = 1 / 3, A = y(), I = y(), L = y();
        t.exports = {
            cubicAt: o,
            cubicDerivativeAt: a,
            cubicRootAt: s,
                ...
                for (var e, i, n, r, o, a, s = this.data, u = this._ux, h = this._uy, c = this._len, d = 0; c > d;) {
                    ...
                    switch (1 == d && (n = s[d], r = s[d + 1], e = n, i = r), f) {
                        ...
                        case l.Q:
                            ...
                            break;
                        case l.A:
                            var p = s[d++], m = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], S = s[d++], M = s[d++], T = x > _ ? x : _, A = x > _ ? 1 : x / _, I = x > _ ? _ / x : 1, L = Math.abs(x - _) > .001, C = b + w;
        ...
        var u = i(14), h = i(30), c = i(1), d = i(11), f = i(23), p = d.getDataItemValue, g = d.converDataValue, v = {
            cartesian2d: function (t, e, i) {
                ...
                }), r = n[0], o = n[1], l = r.get("type"), u = o.get("type"), d = [{
                    name: "x",
                    type: s(l),
                    stackable: a(l)
                ...
                var n = i.queryComponents({
                    ...
                    id: e.get("polarId")
                })[0], r = n.findAxisModel("angleAxis"), o = n.findAxisModel("radiusAxis"), l = o.get("type"), u = r.get("type"), c = [{
                    name: "radius",
                    type: s(l),
                    stackable: a(l)
        ...
        var n = i(4), r = i(8), o = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, u = n.round, h = o.extend({
            type: "interval",
            _interval: 0,
            ...
            niceTicks: function (t) {
                ...
                if (isFinite(i)) {
                    0 > i && (i = -i, e.reverse());
                    var r = u(n.nice(i / t, !0), Math.max(l(e[0]), l(e[1])) + 2), o = l(r) + 2, h = [u(s(e[0] / r) * r, o), u(a(e[1] / r) * r, o)];
        ...
        var o = i(1), a = i(12), s = i(2), l = i(11), u = i(108), h = i(179), c = o.each, d = u.eachAxisDim, f = s.extendComponentModel({
            type: "dataZoom",
        ...
        var s = i(1), l = i(8), u = i(3), h = i(9), c = i(4), d = c.remRadian, f = c.isRadianAroundZero, p = i(5), g = p.applyTransform, v = s.retrieve, m = Math.PI, y = function (t, e) {
            ...
            axisLine: function () {
                ...
                if (o) {
                    ...
                    for (var y = r(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i), S = i.get("triggerEvent"), M = 0; M < f.length; M++)if (!_(s, M, e.labelInterval)) {
                        ...
                        var A = T.getTextColor() || i.get("axisLine.lineStyle.color"), I = s.dataToCoord(f[M]), L = [I, e.labelOffset + e.labelDirection * d], C = s.scale.getLabel(f[M]), D = new u.Text({
                            anid: "label_" + f[M],
                            style: {
                                text: p[M],
                ...
                if (i) {
                    ...
                    var w = f.getFont(), S = e.get("nameTruncate", !0) || {}, M = S.ellipsis, T = v(S.maxWidth, b), A = null != M && null != T ? l.truncateText(i, T, w, M, {
                        minChar: 2,
                        placeholder: S.placeholder
                    }) : i, I = e.get("tooltip", !0), L = e.mainType, C = {componentType: L, name: i, $vars: ["name"]};
        ...
        var u = i(13), h = i(22), c = i(1), d = i(117), f = i(115), p = c.each, g = h.ifAxisCrossZero, v = h.niceScaleExtent;
        i(118);
        var m = o.prototype;
        m.type = "grid", m.getRect = function () {
            ...
            c.each(this._axesList, function (t) {
                ...
                if (l(r)) {
                    ...
                    var h = this.getCartesian(a.componentIndex, u.componentIndex), c = r.getData(), d = h.getAxis("x"), f = h.getAxis("y");
         ...
         */
        var r = i(62), o = i(12), a = i(137), s = i(140), l = i(141), u = i(149), h = !o.canvasSupported, c = {canvas: i(139)}, d = {}, f = {};
        ...
        var u = i(26), h = i(5), c = i(174), d = i(3), f = i(1), p = i(4), g = ["fromSymbol", "toSymbol"], v = l.prototype;
        ...
        var N = i(20), V = i(1), B = i(3), G = i(113), F = i(45), H = V.curry, W = V.each, Z = V.map, q = Math.min, j = Math.max, U = Math.pow, X = 1e4, Y = 6, $ = 6, Q = "globalPan", K = {
            w: [0, 0],
            e: [0, 1],
            n: [1, 0],
            s: [1, 1]
        ...
        var c = i(1), d = i(11), f = i(9), p = c.each, g = c.filter, v = c.map, m = c.isArray, y = c.indexOf, x = c.isObject, _ = i(10), b = i(124), w = "\x00_ec_inner", S = f.extend({
        ...
        var n = i(1), r = i(32), o = i(4), a = i(38), s = r.prototype, l = a.prototype, u = Math.floor, h = Math.ceil, c = Math.pow, d = Math.log, f = r.extend({
            type: "log",
            base: 10,
            getTicks: function () {
        ...
        var n = i(1), r = i(4), o = i(8), a = i(38), s = a.prototype, l = Math.ceil, u = Math.floor, h = 1e3, c = 60 * h, d = 60 * c, f = 24 * d, p = function (t, e, i, n) {
            for (; n > i;) {
                var r = i + n >>> 1;
                t[r][2] < e ? i = r + 1 : n = r
            }
            ...
            for (var h = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (b === u.M && _ > 1 && (i || (h += v(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case u.Q:
                        ...
                        break;
                    case u.A:
                        var w = t[_++], S = t[_++], M = t[_++], T = t[_++], A = t[_++], I = t[_++], L = (t[_++], 1 - t[_++]), C = Math.cos(A) * M + w, D = Math.sin(A) * T + S;
        ...
        var u = i(28).CMD, h = i(82), c = i(145), d = i(83), f = i(144), p = i(61).normalizeRadian, g = i(17), v = i(84), m = h.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var u = i(24), h = i(1), c = i(20), d = i(12), f = i(147), p = u.addEventListener, g = u.removeEventListener, v = u.normalizeEvent, m = 300, y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove"], x = ["touchstart", "touchend", "touchmove"], _ = {
            mousemove: function (t) {
        ...
        function n(t, e, i, n, r, o, a, s, l, u, h) {
            ...
            _ > 1 && (a *= c(_), s *= c(_));
            var b = (r === o ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) + s * s * (y * y))) || 0, w = b * a * x / s, S = b * -s * y / a, M = (t + i) / 2 + f(g) * w - d(g) * S, T = (e + n) / 2 + d(g) * w + f(g) * S, A = m([1, 0], [(y - w) / a, (x - S) / s]), I = [(y - w) / a, (x - S) / s], L = [(-1 * y - w) / a, (-1 * x - S) / s], C = m(I, L);
        ...
        var a = i(6), s = i(28), l = i(167), u = i(19), h = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], c = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
        ...
        var l = i(1), u = i(18), h = i(24), c = i(8), d = l.each, f = c.toCamelCase, p = i(12), g = ["", "-webkit-", "-moz-", "-o-"], v = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
        a.prototype = {
        ...
        if (!i(12).canvasSupported) {
            var n = i(5), r = i(7), o = i(28).CMD, a = i(18), s = i(16), l = i(75), u = i(37), h = i(48), c = i(74), d = i(6), f = i(29), p = i(168), g = Math.round, v = Math.sqrt, m = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", S = "progid:DXImageTransform.Microsoft", M = 21600, T = M / 2, A = 1e5, I = 1e3, L = function (t) {
                ...
                for (a = 0; a < t.length;) {
                    switch (r = t[a++], n = "", i = 0, r) {
                        ...
                        case d:
                            ...
                            a++;
                            var F = t[a++], H = O + y(V) * R, W = E + x(V) * N, S = O + y(B) * R, A = E + x(B) * N, Z = F ? " wa " : " at ";
            ...
            h.prototype.brushVML = function (t) {
                ...
                if (r) {
                    var u = n.x || 0, h = n.y || 0, c = n.width, d = n.height, f = n.sWidth, m = n.sHeight, y = n.sx || 0, x = n.sy || 0, M = f && m, T = this._vmlEl;
        ...
        a.prototype = {
            constructor: a, draw: function (t, e, i, a, s) {
                ...
                u.each(c.regions, function (e) {
                    ...
                    var T = _.get("show"), A = b.get("show"), I = h && isNaN(h.get("value", o)), L = h && h.getItemLayout(o);
        ...
        var n = i(2), r = i(1), o = i(12), a = i(382), s = i(71), l = i(172), u = s.mapVisual, h = i(11), c = s.eachVisual, d = i(4), f = r.isArray, p = r.each, g = d.asc, v = d.linearMap, m = r.noop, y = ["#f6efa6", "#d88273", "#bf444c"], x = n.extendComponentModel({
            type: "visualMap",
            dependencies: ["series"],
        ...
        t.exports = function (t) {
            t.eachSeriesByType("candlestick", function (t) {
                ...
                n.each(r, function () {
                    ...
                    var l = arguments, u = r.length, h = l[0], c = l[u], d = "horizontal" === o ? 0 : 1, f = 1 - d, p = l[1], g = l[2], v = l[3], m = l[4], y = Math.min(p, g), x = Math.max(p, g), _ = t(y), b = t(x), w = t(v), S = t(m), M = [[S, b], [w, _]], T = [];
        ...
        var o = i(263), a = i(3), s = i(4), l = s.parsePercent, u = 2 * Math.PI, h = i(27).extend({
            ...
            _renderTicks: function (t, e, i, n, o, u, h, c) {
                for (var d = this.group, f = o.cx, p = o.cy, g = o.r, v = t.get("min"), m = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), T = u, A = (h - u) / b, I = A / w, L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; b >= P; P++) {
                    ...
                    if (_.get("show")) {
                        var E = r(s.round(P / b * (m - v) + v), _.get("formatter")), R = _.get("distance"), N = new a.Text({
                            style: {
                                text: E,
                                x: k * (g - S - R) + f,
                                y: z * (g - S - R) + p,
        ...
        var r = i(39), o = i(93), a = i(78), s = i(3), l = i(267), u = i(1), h = ["itemStyle", "normal", "opacity"], c = ["lineStyle", "normal", "opacity"];
        i(2).extendChartView({
            type: "graph", init: function (t, e) {
                ...
                var p = "circular" === t.get("layout") && t.get("circular.rotateLabel"), g = h.getLayout("cx"), v = h.getLayout("cy");
        ...
        t.exports = function (t) {
            t.eachSeriesByType("graph", function (t) {
                var e = t.getGraph(), n = t.getEdgeData(), r = i(t.get("edgeSymbol")), o = i(t.get("edgeSymbolSize")), a = "lineStyle.normal.color".split("."), s = "lineStyle.normal.opacity".split(".");
                n.setVisual("fromSymbol", r && r[0]), n.setVisual("toSymbol", r && r[1]), n.setVisual("fromSymbolSize", o && o[0]), n.setVisual("toSymbolSize", o && o[1]), n.setVisual("color", t.get(a)), n.setVisual("opacity", t.get(s)), n.each(function (t) {
                    var r = n.getItemModel(t), o = e.getEdgeByIndex(t), l = i(r.getShallow("symbol", !0)), u = i(r.getShallow("symbolSize", !0)), h = r.get(a), c = r.get(s);
                    switch (h) {
                        case"source":
        ...
        t.exports = function (t) {
            t.eachSeriesByType("graph", function (t) {
                ...
                if (!e || "view" === e.type)if ("force" === t.get("layout")) {
                    ...
                    var p = h.getDataExtent("value"), g = c.getDataExtent("value"), v = d.get("repulsion"), m = d.get("edgeLength");
        ...
        var n = i(14), r = i(15), o = i(1), a = i(30), s = i(8), l = s.encodeHTML, u = s.addCommas, h = i(66), c = i(171), d = r.extend({
            type: "series.map",
            layoutMode: "box",
            needsDrawMap: !1,
            seriesGroup: [],
        ...
        function r(t, e, i, n, r, l, u, h, c, d) {
            ...
            if (u) {
                var A = u.getLayout();
                if (A && A.isInView) {
                    var I = A.width, L = A.height, C = A.invisible, D = u.getRawIndex(), P = h && h.getRawIndex(), k = x("nodeGroup", v);
                    if (k) {
        ...
        var a = i(1), s = i(3), l = i(45), u = i(170), h = i(311), c = i(78), d = i(7), f = i(19), p = i(380), g = a.bind, v = s.Group, m = s.Rect, y = a.each, x = 3, _ = ["label", "normal"], b = ["label", "emphasis"], w = 10, S = 1, M = 2;
        t.exports = i(2).extendChartView({
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), o = e.getHeight(), a = t.option, s = a.size || [], l = b(w(a.width, s[0]), n), u = b(w(a.height, s[1]), o), h = v.getLayoutRect(t.getBoxLayoutParams(), {
                    width: e.getWidth(),
                    height: e.getHeight()
                }), g = i && i.type, x = m.retrieveTargetInfo(i, t), _ = "treemapRender" === g || "treemapMove" === g ? i.rootRect : null, M = t.getViewRoot(), T = m.getPathToRoot(M);
                if ("treemapMove" !== g) {
        ...
        var p = i(1), g = i(4), v = i(13), m = i(170), y = i(7), m = i(170), x = Math.max, _ = Math.min, b = g.parsePercent, w = p.retrieve, S = p.each;
        t.exports = n
    }, function (t, e, i) {
        ...
        var h = i(2), c = i(172), d = i(1), f = i(7), p = i(328), g = i(81), v = i(112), m = ["inBrush", "outOfBrush"], y = "__ecBrushSelect", x = "__ecInBrushSelectEvent", _ = h.PRIORITY.VISUAL.BRUSH;
        ...
        var s = i(1), l = i(3), u = i(13), h = i(343), c = i(341), d = i(26), f = i(22), p = i(7), g = i(19), v = i(4), m = i(8), y = m.encodeHTML, x = s.bind, _ = s.each, b = Math.PI;
        t.exports = h.extend({
            type: "timeline.slider", init: function (t, e) {
                ...
                g = g * b / 180;
                var v, m, y, x, _ = h.get("position", !0), c = h.get("show", !0), w = c && h.get("showPlayBtn", !0), S = c && h.get("showPrevBtn", !0), M = c && h.get("showNextBtn", !0), T = 0, A = u;
        ...
        var l = i(231), u = i(3), h = i(1), c = i(4), d = i(79), f = i(85), p = i(232), g = i(11), v = c.linearMap, m = h.each, y = Math.min, x = Math.max, _ = 12, b = 6, w = l.extend({
            type: "visualMap.continuous",
            init: function () {
